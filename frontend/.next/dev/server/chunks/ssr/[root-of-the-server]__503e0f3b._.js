...
function OrdersPage() {
    ...
    const fetchOrders = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$config$2f$Api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("api/v1/user/orders/");
            setOrders(res.data);
        } catch (err) {
            console.error(err);
        } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__503e0f3b._.js.map
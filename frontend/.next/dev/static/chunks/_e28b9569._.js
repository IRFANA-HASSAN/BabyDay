...
"[project]/components/config/Api.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$config$2f$Api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/config/Api.jsx [app-client] (ecmascript)");
...
function OrdersPage() {
    ...
    const fetchOrders = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$config$2f$Api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("api/v1/user/orders/");
            setOrders(res.data);
        } catch (err) {
            console.error(err);
        } finally{
...
//# sourceMappingURL=_e28b9569._.js.map